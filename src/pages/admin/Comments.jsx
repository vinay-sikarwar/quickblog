...
const Comments = () => {
    ...
    const fetchComments = async () => {
        try {
            ...
            // For each blog, get its comments
    ...
    <>
        <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
            <h1 className='text-2xl font-bold mb-6 text-gray-800'>All Comments</h1>
                            ...
                            {allComments.map((comment, index) => (
                                <tr key={comment.id} className='border-b border-gray-200 hover:bg-gray-50'>
                                    ...
                                    <td className='px-6 py-4'>
                                        <div className='font-medium text-gray-900'>{comment.blogTitle}</div>
                                    </td>
                                    <td className='px-6 py-4'>
                                    ...
                                    <td className='px-6 py-4 max-w-xs'>
                                        <p className='text-sm text-gray-600 truncate'>{comment.text}</p>
                                    </td>
